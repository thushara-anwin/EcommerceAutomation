...
custom_tshirt_code = (By.ID,"sku-29")
custom_t_shirt_quantity = (By.ID,"product_enteredQuantity_29")
...
message_added_to_cart = (By.XPATH,"//p[@class='content']")
warning_enter_your_text = (By.XPATH,"//p[@class='content']")
warning_maximum_quantity = (By.XPATH,"//p[@class='content']")
